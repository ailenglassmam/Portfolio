  ...
  return (
    ...
    <section id='Skills' className='mx-auto py-32'>
      ...
      <div className='px-6 sm:px-16 xl:px-24'>
        ...
        <div className='w-full flex flex-wrap justify-between items-center gap-6 my-10 p-7 border-2 border-black rounded-[30px]'>
        ...
        <div className='w-full h-fit flex flex-wrap gap-10 my-10'>
          <div className=' lg:w-5/12 p-7 border-2 border-black rounded-[30px] bg-[#F8D44C]'>
          ...
          <div className=' flex-grow p-7 border-2 border-black rounded-[30px]'>
            <h4 className='text-[20px]'>Habilidades Blandas</h4>
            <ul class="grid md:grid-cols-2 mt-5">
