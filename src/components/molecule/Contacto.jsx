...
export default function Contacto() {
  return (
    <section id="Contacto" name="section4" className="h-fit mx-auto py-32 flex justify-center items-center">
      ...
      <div className="px-6 sm:px-16 xl:px-24 flex flex-col lg:flex-row justify-center items-center gap-4 md:gap-10 xl:gap-20">
        ...
        <div className="lg:w-[40%] h-fit p-[30px] mt-8 md:mt-0 bg-[#99B7DD] border-2 xl:border-[3px] border-black rounded-[30px] flex flex-col justify-center items-center shadow-[10px_10px_0px_rgba(0,0,0,0.25)]">
          ...
          <a href="https://www.linkedin.com/in/ailenglassmam/" target="_blank" className="w-[60%] py-2 my-2 bg-[#ECECEC] text-center border-2 xl:border-[3px] border-black rounded-md transition md:hover:shadow-[7px_7px_0px_rgba(0,0,0,0.25)] duration-150">LinkedIn</a>
          <a href="mailto:ailenglas97@gmail.com" className="w-[60%] py-2 my-2 bg-[#ECECEC] text-center border-2 xl:border-[3px] border-black rounded-md transition md:hover:shadow-[7px_7px_0px_rgba(0,0,0,0.25)] duration-150">E-Mail</a>
          <a href="tel:+5491159619094" className="w-[60%] py-2 my-2 bg-[#ECECEC] text-center border-2 xl:border-[3px] border-black rounded-md transition md:hover:shadow-[7px_7px_0px_rgba(0,0,0,0.25)] duration-150">WhatsApp</a>
        </div>
        {/* contenedor contactos */}
      </div>
    </section>
