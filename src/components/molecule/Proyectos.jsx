...
export default function Proyectos() {
  ...
  const proyectos = proyectosData.map(proyecto => {
    return (
      <div className="min-w-[250px] md:min-w-[300px] p-7 border-2 xl:border-[3px] border-black rounded-[30px] transition md:hover:shadow-[7px_7px_0px_rgba(0,0,0,0.25)] duration-150" key={proyecto.id}>
        ...
        <div>
          ...
          <p className="text-sm md:text-md mt-[24px] mb-20">{proyecto.descripcion}</p>
          <span className={`text-xs px-3 py-1 border-2 xl:border-[3px] border-black rounded-md ${proyecto.tipologia === "Front End" ? "bg-[#99B7DD]" : proyecto.tipologia === "Back End" ? "bg-[#F8D44C]" : proyecto.tipologia === "Framework" ? "bg-[#EA7A54]" : "bg-[#A9D86C]"}`}>{proyecto.tipologia}</span>
        </div>
  ...
  return (
    <>
      <section id="Proyectos" name="section3" className="w-full mx-auto py-32 flex flex-col justify-center items-center">
      ...
      <div className="px-6 sm:px-16 xl:px-24 pt-6 sm:pt-16 xl:pt-10 text-center">
