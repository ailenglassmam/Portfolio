...
export default function SobreMi() {
  ...
  return (
    <section id='SobreMi' className='mx-auto py-16 lg:py-32 h-fit px-6 sm:px-16 xl:px-24'>
      ...
      <div className='flex flex-col xl:flex-row justify-center items-center gap-4 md:gap-10 xl:gap-20 md:mt-16'>
        ...
        {/* contenedor de texto */}
        <div className='w-full xl:w-1/2 p-7 bg-[#F8D44C] border-2 border-black rounded-[50px] shadow-[7px_7px_0px_rgba(0,0,0,0.25)] gap-4'>
