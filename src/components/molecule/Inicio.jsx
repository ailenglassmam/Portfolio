...
export default function Inicio() {
  return (
    <section id="Inicio" name="section1" className="mx-auto py-24 lg:py-32 px-6 sm:px-16 xl:px-24">
      ...
      <div className="flex flex-col-reverse lg:flex-row justify-center items-center gap-14 md:gap-10 xl:gap-20 lg:mt-8">
        ...
        <div className="w-full lg:w-[60%]">
          ...
          {/*boton redireccionamiento a una pagina nueva */}
          <Link to="/sobremi" className="px-10 py-2 bg-[#A9D86C] border-2 xl:border-[3px] border-black rounded-md transition md:hover:shadow-[7px_7px_0px_rgba(0,0,0,0.25)] duration-150">Ver Más</Link>
          {/*boton redireccionamiento a una pagina nueva */}
        </div>

        {/* contenedor de imagen */}
        <div className="w-3/4 md:w-96 md:h-96 xl:w-[500px] xl:h-[500px] bg-[#F8D44C] p-4 border-2 xl:border-[3px] border-black rounded-[30px] flex justify-center items-center shadow-[10px_10px_0px_rgba(0,0,0,0.25)]">
          <img src={avatar} alt="Avatar" className=" md:h-3/4" />
        </div>
        {/* contenedor de imagen */}
      ...
      {/* contenedor de frase */}
      <div className="w-full p-4 md:h-28 rounded-[30px] border-2 xl:border-[3px] border-black bg-[#99B7DD] flex justify-center items-center mt-32 md:mt-28">
